...
public class JFPrincipal extends javax.swing.JFrame implements Runnable{
    ...
    private void jMenuItem11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem11ActionPerformed
        // TODO add your handling code here:
        try{
            int venta = Integer.parseInt(JOptionPane.showInputDialog(null, "Ingrese el código de la venta"));
            JDVentas objVentas = new JDVentas(this, true);
            objVentas.setVenta(venta);
            objVentas.setLocationRelativeTo(this);
            objVentas.setVisible(true);
        }catch(Exception e){
            JOptionPane.showMessageDialog(rootPane, "Código de venta incorrecto");
        }
