 ...
 * @author JCarlos
 */
public class JDReporteAgotamientos extends javax.swing.JDialog {

    /**
     * Creates new form JDReporteProductos
     */
    public JDReporteAgotamientos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle(".:REPORTE DE AGOTAMIENTO:.");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try {
            ...
            JRViewer vistaReporte = new Reportes().reporteInterno("rp_agotamiento.jasper", null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDReporteAgotamientos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDReporteAgotamientos dialog = new JDReporteAgotamientos(new javax.swing.JFrame(), true);
