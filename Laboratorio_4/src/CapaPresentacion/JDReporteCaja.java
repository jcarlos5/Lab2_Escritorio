 ...
 * @author JCarlos
 */
public class JDReporteCaja extends javax.swing.JDialog {

    /**
     * Creates new form JDReporteCaja
     */
    public JDReporteCaja(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try {
            ...
            float montoCajera = Float.parseFloat(String.valueOf(JOptionPane.showInputDialog("Ingrese el monto de Caja")));
            ...
            parametros.put("M_Actual",montoCajera);
            parametros.put("M_Total",MontoTOTAL_CAJA);
            parametros.put("M_Contado",VentasCONTADO);
            parametros.put("M_Credito",VentasCREDITO);
            parametros.put("M_Cuotas",VentasCUOTA);
            
            JRViewer vistaReporte = new Reportes().reporteInterno("rp_Caja.jasper",parametros);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDReporteCaja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDReporteCaja dialog = new JDReporteCaja(new javax.swing.JFrame(), true);
