 ...
 * @author JCarlos
 */
public class JDReporteCategoriasGrupo extends javax.swing.JDialog {

    /**
     * Creates new form JDReporteCategoriasGrupo
     */
    public JDReporteCategoriasGrupo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle(".:REPORTE DE GRUPOS DE CATEGORÍAS");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try {
            ...
            JRViewer vistaReporte = new Reportes().reporteInterno("rp_ProductosPorCategoria.jasper", null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDReporteCategoriasGrupo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDReporteCategoriasGrupo dialog = new JDReporteCategoriasGrupo(new javax.swing.JFrame(), true);
