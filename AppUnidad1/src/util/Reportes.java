...
public class Reportes 
{
    ...
    public static final String RUTA_REPORTES = "src\\Reporte\\";
    ...
    public JRViewer reporteInternoHorizontal(String archivoReporte, Map<String,Object> parametros) throws Exception{
        try {
            ...
            clsJDBC objConexion = new clsJDBC();
            objConexion.conectar();
            JasperPrint reporte = JasperFillManager.fillReport(Reportes.RUTA_REPORTES + archivoReporte, parametros, objConexion.getConnection());
            JRViewer visor =new JRViewer(reporte);
